...
export function Toast({ toasts, onDismiss }: ToastProps) {
  const getColors = (type: ToastMessage["type"]) => {
    switch (type) {
      case "success":
        return { bg: "#5b9aa8", border: "#2d1b0e", text: "#fef9ed" };
      case "warning":
        return { bg: "#f4d35e", border: "#2d1b0e", text: "#2d1b0e" };
      case "error":
        return { bg: "#c44536", border: "#2d1b0e", text: "#fef9ed" };
      default: // info
        return { bg: "#fef9ed", border: "#2d1b0e", text: "#2d1b0e" };
    }
  };
  ...
  return (
    <div className="fixed top-4 right-4 z-50 space-y-2 pointer-events-none">
      <AnimatePresence>
        {toasts
          // تجاهُل أي توست رسالته فاضية أو مسافات فقط
          ...
          .map((toast) => {
            ...
            return (
              ...
              >
                ...
                >
                  <p
                    className="flex-1 uppercase tracking-wide text-[0.9rem]"
